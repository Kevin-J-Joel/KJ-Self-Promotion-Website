...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "js/iscroll.js", user: true },
      { load: "js/EdgeCommons.js", user: true },
      { load: "portfolio25_edge.js"},
      { load: "portfolio25_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0px",maxPlW="none",plWidth="1920px",plHeight="2764px";
